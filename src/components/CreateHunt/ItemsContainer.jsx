...
function ItemsContainer(props) {
  const { classes, dispatch, items } = props;
    ...
    <List dense={true} className={classes.list}>
      ...
      <div className={classes.container}>
        <TextField
          ...
          className={classNames(classes.textField, classes.field, classes.root)}
          margin="normal"
        ...
        <TextField
          ...
          value={inputPoints}
          FormHelperTextProps={inputPointsErr.inError ? { error: true } : null}
